...
public class PCLT1 {
	...
	public void getContactListInfo() {
		given().get("http://3.13.86.142:3000/contacts")
	...
	public void AddContact() {
		...
		details.put("email", "indirapatole@xyz.com");
		details.put("location", loc);
		details.put("employer", emp);
		
		ExtractableResponse<Response> eres = given().header("Content-Type","application/json")
	...
	public void updateContact() {
		...
		emp.put("jobTitle", "AT");
		emp.put("company", "LTI");
		details.put("firstName", "Nirmohi");
		details.put("lastName", "Patole");
		details.put("email", "nirmohiPatole@xyz.com");
		details.put("location", loc);
		details.put("employer", emp);
